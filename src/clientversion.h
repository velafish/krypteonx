...
// 👉 Versione Krypteonx v4.4.0.0-Post-Halving
...
#error Client version information missing: version is not defined by krypteonx-config.h or in any other way
#endif
...
/**
 * krypteonxd-res.rc includes this file, but it cannot cope with real c++ code.
