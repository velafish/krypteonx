...
#ifndef KRTPTEONX_ARITH_UINT256_H
#define KRTPTEONX_ARITH_UINT256_H
...
public:
     ...
     *
     * Krypteonx only uses this "compact" format for encoding difficulty
...
#endif // KRTPTEONX_ARITH_UINT256_H
