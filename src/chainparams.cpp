...
public:
    CMainParams()
    {
        ...
        consensus.nPowTargetTimespan = 24 * 10 * 30;                                                       // Krypteonx: 1 day
        consensus.nPowTargetSpacing = 1 * 10;                                                              // Krypteonx: 2 minutes
         ...
         */
        pchMessageStart[0] = 0xa1; // f
        pchMessageStart[1] = 0xb2; // b
        pchMessageStart[2] = 0xc3; // c
