...
//! Interface for the src/evo part of a krypteonx node (krypteonxd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a krypteonx node (krypteonxd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a krypteonx node (krypteonxd process).
namespace Smartnode {
class Sync
{
public:
...
//! Top-level interface for a krypteonx node (krypteonxd process).
class Node
{
public:
    virtual ~Node() {}
