    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage:\n"
                         "  krypteonx-qt [command-line options]                     \n";
...
All the Krypteonx in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 KRY, 0.01 KRY, 0.1 KRY, 1 KRY and 10 KRY -- sort of like the paper money you use every day.</li> \
