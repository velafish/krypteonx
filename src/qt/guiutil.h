...
/** Utility functions used by the Krypteonx Qt UI.
 */
namespace GUIUtil {
...
// Parse "krypteonx:" URI into recipient object, return true on successful parsing
...
/** Load krypteonx specific appliciation fonts */
bool loadFonts();
...
/** Check if a krypteonx specific theme is activated (light/dark).*/
