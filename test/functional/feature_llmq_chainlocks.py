...
from test_framework.test_framework import KrypteonxTestFramework
...
class LLMQChainLocksTest(KrypteonxTestFramework):
    def set_test_params(self):
        self.set_krypteonx_test_params(6, 5, fast_dip3_enforcement=True)
