...
"""Verify that starting krypteonxd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start krypteonxd with -h for help text")
        ...
        self.log.info("Start krypteonxd with -version for version information")
