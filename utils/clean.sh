...
rm -f src/config/krypteonx-config.h
...
rm -rf test_bitcoin.coverage/ krypteonx-gtest.coverage/ total.coverage/
...
clean_exe src/krypteonx-cli
clean_exe src/krypteonxd
clean_exe src/krypteonx-gtest
clean_exe src/krypteonx-tx
clean_exe src/test/test_krypteonx
clean_exe src/test/test_krypteonx_fuzzy
...
clean_dep . src/config/krypteonx-config.h.in
