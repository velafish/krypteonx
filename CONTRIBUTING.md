# Contributing to Krypteonx Core

The Krypteonx Core project operates an open contributor model where anyone is
...
-   _Qt_ for changes to krypteonx-qt
...
[Translation Process](https://github.com/Krypteonx-Coin/Core-Wallet/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Krypteonx Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Krypteonx
Network Protocol consensus changes.

Whether a pull request is merged into Krypteonx Core rests with the project merge
...
Patches that change Krypteonx consensus rules are considerably more involved than
...
Where a patch set proposes to change the Krypteonx consensus, it must have been
...
The review process is normally fairly responsive on the Krypteonx Core repository, however
...
The project leader is the release manager for each Krypteonx Core release.
