...
-   krypteonx.conf: contains configuration settings for krypteonxd or krypteonx-qt
-   krypteonxd.pid: stores the process id of krypteonxd while running
-   database/\*: BDB database environment; only used for wallet
-   db.log: wallet database log file
-   debug.log: contains debug information and general logging generated by krypteonxd or krypteonx-qt
