...
This mechanism has been integrated into Bitcore-Node-Krypteonx which allows for notification to be broadcast through Insight API in one of two ways:

-   WebSocket: [https://github.com/krypteonx/insight-api-krypteonx#web-socket-api](https://github.com/krypteonx/insight-api-krypteonx#web-socket-api)
-   API: [https://github.com/krypteonx/insight-api-krypteonx#instantsend-transactions](https://github.com/krypteonx/insight-api-krypteonx#instantsend-transactions)
